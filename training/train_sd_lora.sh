...
accelerate launch --mixed_precision="fp16" --multi_gpu --num_processes 6 --gpu_ids='all' train_sd_lora.py \
  ...
  --num_train_epochs 12  --checkpointing_steps=500 \
  --max_grad_norm=1 \
  --use_8bit_adam \
